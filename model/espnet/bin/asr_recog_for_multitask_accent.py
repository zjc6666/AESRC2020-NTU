...
def get_parser():
    ...
    # add by ZJC to save Posterior probability
    parser.add("--pospro", default="", type=str, help="Config file path")
    parser.add("--job", default="1", type=str, help="job name")
    ...
    parser.add_argument('--dev-xvector', default="", type=str,
                       help='dev-xvector files')
    parser.add_argument('--xvector-pro', default=0.5, type=float,
                       help='xvectors proportion')
    parser.add_argument('--recog-mode', default="asr", type=str,
                       help=' decode mod for multitask asr or accent')
    parser.add_argument('--soft-weight-output', default="", type=str,
                       help=' save weight file')

    parser.add_argument('--embeddingLayer', default=3, type=int,
                       help='the later selected for the accent vector')

   # for access all layer
    parser.add_argument('--AccentLayer', default=12, type=int,
                       help='the later selected for the accent vector')
        ...
        if args.backend == "chainer":
            ...
            if args.num_encs == 1:
                ...
                if args.api == "v2":
                    ...
                    from espnet.asr.pytorch_backend.asr_transformer_multitask_with_accent import recog
