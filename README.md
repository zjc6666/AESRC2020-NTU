...
Instructions for use
  1. Data preparation
    ...
    In order to better reproduce my experimental results, you can download the data set first, and then directly change the path in wav.scp in different data sets in data.<br>
